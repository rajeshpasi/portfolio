...
const HeroSection = () => {
  ...
  return (
    <HeroContainer id="hero-section">
      ...
      <FloatingElement
        sx={{ top: "20%", right: "15%", animationDelay: "2s" }}
      />
      <FloatingElement
        sx={{ bottom: "15%", left: "20%", animationDelay: "4s" }}
      />
      <FloatingElement
        sx={{ bottom: "25%", right: "10%", animationDelay: "1s" }}
      />
      ...
      <GlassCard className="max-w-4xl mx-auto">
        <Stack spacing={3} alignItems="center">
          ...
          >
            ...
            Passionate about creating beautiful, functional applications and
