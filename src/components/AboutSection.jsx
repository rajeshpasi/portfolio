        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <GlassCard>
            <Stack spacing={3}>
              ...
              >
                I'm a passionate self-taught web developer with a deep love for creating 
                beautiful and functional web applications. My journey began with curiosity 
                about how websites work, and it has evolved into a comprehensive skill set 
                in the MERN stack.
              </Typography>
              ...
              >
                Currently, I'm expanding my horizons by diving into the fascinating world 
                of Generative AI and Python. I believe in continuous learning and staying 
                updated with the latest technologies to build innovative solutions.
              </Typography>
              ...
              >
                ...
                to open-source projects, or experimenting with AI models. I'm always excited 
